...
# -*- coding: utf-8 -*-
"""
Script para ejecutar todos los tests de drones.
...
def run_drone_tests():
    """Ejecuta todos los tests de drones y muestra resultados detallados"""
    
    # Obtener la ruta del directorio actual
    current_dir = Path(__file__).parent
    project_root = current_dir.parent.parent
    
    print("🚁 SISTEMA DE TESTING DE DRONES")
    print("=" * 50)
    ...
    if success_rate == 100:
        print("\n🎉 ¡TODOS LOS TESTS DE DRONES PASAN! 🎉")
...
def run_specific_drone_test(component_name):
    """Ejecuta tests para un componente específico de drones"""
    
    test_file = f"test_{component_name}.py"
    current_dir = Path(__file__).parent
    test_path = current_dir / test_file
    ...
    print(f"🎯 EJECUTANDO TESTS ESPECÍFICOS: {component_name.upper()}")
    print("=" * 50)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        run_specific_drone_test(component_name)
    else:
